...
class Ui_MainWindow(object):
    ...
    def load_data_from_database(self):
        ...
        # Data that is needed to create prediction (item name, quantity, duration)
        self.X_coordinate = []
        # Prediction data (on time values of all shipped items)
        self.y_coordinate = []
    ...
    def save_shippeditem(self):
        ...
        shippeditemQuantity = self.shippedItemQuantityValue.text().title()
        shippeditemDuration = self.shippedItemDurationValue.text().title()
